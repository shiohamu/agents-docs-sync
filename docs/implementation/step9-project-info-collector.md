# ステップ9: プロジェクト情報収集モジュールの作成

## 目的

プロジェクトからビルド/テスト手順、コーディング規約、依存関係などの情報を自動収集するモジュールを作成します。
...
- [ ] `collectors`ディレクトリが正しく作成されているか
- [ ] `ProjectInfoCollector`クラスが正しく実装されているか
- [ ] 各収集メソッドが期待通りに動作するか
- [ ] エラーハンドリングが適切か

## 次のステップ

このステップが完了したら、[ステップ10: AGENTS.md生成設定の拡張](./step10-agents-config-extension.md)に進んでください。
